        ...
        >
          {[...items, ...items].map((item, index) => (
            <div key={index} className="flex items-center gap-8 group">
              <span className="text-3xl sm:text-4xl md:text-5xl font-display font-bold uppercase tracking-widest text-transparent bg-clip-text bg-linear-to-r from-brand-text to-brand-text/50 group-hover:from-brand-accent group-hover:to-lime-500 transition-all duration-300">
                {item}
              </span>
